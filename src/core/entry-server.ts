...
import type { SsrHandler, SsrRenderer, Context, Options, SSRPageDescriptor } from "./types";
...
export const coreSSR: SsrHandler = function (options, hook) {
